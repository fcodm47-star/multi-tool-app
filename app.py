...
# Initialize extensions (these are module-level)
socketio = SocketIO()
bcrypt = Bcrypt()
...
# ===== IMPORTANT: Create the app instance at module level =====
...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=port, debug=False)    # Login manager settings
    login_manager.login_view = 'auth.login'
    login_manager.login_message = 'Please log in to access this page'
    login_manager.login_message_category = 'info'
